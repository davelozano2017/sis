    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-md-4">
            <div class="panel panel-body has-bg-image">
                <div class="media no-margin">
                    <div class="media-body">
                        <h3 class="no-margin"><?=$data['teachers']->num_rows?></h3>
                        <span class="text-uppercase text-size-mini">Teachers</span>
                    </div>
        ...
        <div class="col-sm-6 col-md-4">
            <div class="panel panel-body has-bg-image">
                <div class="media no-margin">
                    <div class="media-body">
                        <h3 class="no-margin"><?=$data['events']->num_rows?></h3>
                        <span class="text-uppercase text-size-mini">Events</span>
                    </div>
