...
<tr>
    <th style="border:1px solid #fff;width:12%"><img style="margin-top:3px;width:80px;height:80px;padding:5px"src="http://localhost/sis/assets/images/logo.jpg"></th>
    <th style="border:1px solid #fff;width:76%">
    MENDEZ CHRISTIAN ACADEMY <br> 
    Asis III, Mendez, Cavite <br>
    DepEd Recognition No. 18 s. 2011 <br>
    REPORT CARD <br>
    High School Department
    </th>

<th style="border:1px solid #fff;width:12%"><img style="margin-top:3px;width:80px;height:80px;padding:5px" src="http://www.freelogovectors.net/wp-content/uploads/2014/05/deped-logo.png"></th>
...
<br>
    ...
    <table class="tg" style="width:100%">
        ...
        <tr>
            ...
            <td class="tg-uys7">Final Rating </td>
