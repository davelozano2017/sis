...
<div style="width:365px" >
    <table class="tg" style="width:100%">
        ...
        <tr>
            <td class="tg-l711" colspan="5"><?=$rownine['subjects_name']?> III</td>
            <td class="tg-l711"><input type="text" value="<?=$rownine['first']?>" style="width:100%"></td>
            <td class="tg-l711"><input type="text" value="<?=$rownine['second']?>" style="width:100%"></td>
            <td class="tg-l711"><input type="text" value="<?=$rownine['third']?>" style="width:100%"></td>
            <td class="tg-l711"><input type="text" value="<?=$rownine['fourth']?>" style="width:100%"></td>
            <td class="tg-l711" colspan="3"><input type="text" value="<?=$average3?>" style="width:100%;text-align:center"></td>
            <td class="tg-l711" colspan="3"><input type="text" style="width:100%"></td>
            <td class="tg-us36" colspan="3"><input type="text" style="width:100%"></td>
        </tr>
        <?php } ?>
...
<script>
document.getElementById('seven').value = '<?=$rowseven['sy']?>';
document.getElementById('eight').value = '<?=$roweight['sy']?>';
document.getElementById('nine').value = '<?=$rownine['sy']?>';
document.getElementById('ten').value = '<?=$rowten['sy']?>';
</script>
</body>
</html>