...
<tr>
    ...
    <td style="border-bottom:1px solid #000;border-left:#fff solid 1px;border-right:#fff solid 1px;width:40%"><input type="text" style="width:100%"></td>
    <td style="border-bottom:1px solid #000;border-left:#fff solid 1px;border-right:#fff solid 1px;width:10%">Date of Birth:  </td>
    <td style="border-bottom:1px solid #000;border-left:#fff solid 1px;border-right:#fff solid 1px;width:20%"><input type="text" style="width:100%"></td>
</tr>
</table >
...
<td style="border-left:1px solid #fff;border-top:1px solid #fff;border-right:1px solid #fff;border-bottom:1px solid #000;width:66%margin-right:5px" ><input type="text" style="width:100%"></td>
...
<td style="border:1px solid #fff;border-bottom:1px solid #000;width:40%" > <input type="text" style="width:100%"> </td>
...
<td style="border-left:1px solid #fff;border-top:1px solid #fff;border-right:1px solid #fff;border-bottom:1px solid #000;width:70%" ><input type="text" style="width:100%"></td>
...
<div style="width:365px;float:right" >
    <table class="tg" style="width:100%">
        ...
        <tr>
            ...
            <td class="tg-us36" colspan=8> SY <input type="text" style="width:70%"></td>
        </tr>
        <tr>
